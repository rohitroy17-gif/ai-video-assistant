...
def check_deno():
    """
    Check whether Deno is available in the Streamlit Cloud environment.
    """
...
with st.sidebar:
    ...
    with st.expander("🔧 System Diagnostics"):
        ...
        if deno["installed"]:
            ...
            st.error("Deno NOT detected")

            st.caption(
                "YouTube extraction may fail because "
